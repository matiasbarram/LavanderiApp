...
export default function OrderDetailsForm({ className, number, control, setShowSeco, showSeco }: OrderDetailsFormProps) {
            ...
            <Card className={className}>
                ...
                <CardContent>
                    ...
                    <div className="flex items-center space-x-2">
                        <CustomInputField control={control} type="switch" formFieldName="seco" label="¿Va al seco?" placeholder="Marque si va al seco..." value={showSeco} setValue={setShowSeco} />
                    </div>
                    {showSeco && (
