                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        <Tabs defaultValue="details">
                            <TabsList className="grid w-full grid-cols-2">
                                <TabsTrigger value="details">Pedido</TabsTrigger>
                                <TabsTrigger value="payment">Pago</TabsTrigger>
                            </TabsList>

                            <TabsContent value="details">
                                <OrderDetailsForm number={1} formSetValue={form.setValue} control={form.control} setShowSeco={setShowSeco} showSeco={showSeco} />
                            </TabsContent>
                            <TabsContent value="payment">
                                <OrderPaymentForm className="min-h-[400px]" number={2} formSetValue={form.setValue} control={form.control} isPaid={paymentStatus} setIsPaid={setPaymentStatus} />
                            </TabsContent>
